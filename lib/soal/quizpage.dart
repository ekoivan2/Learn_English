...
import 'package:app_background/soal/resultpage.dart';
...
class getjson extends StatelessWidget {
  ...
  setasset() {
    ...
    } else if (langname == "Normal") {
      assettoload = "assets/normal.json";
    }
      ...
      onWillPop: () {
        return showDialog(
            ...
            builder: (context) => AlertDialog(
                  ...
                  content:
                      Text("Tidak bisa kembali sebelum soal selesai ya. . . ."),
                  actions: <Widget>[
                    FlatButton(
                      onPressed: () {
